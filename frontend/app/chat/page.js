...
export default function ChatPage() {
  ...
  return (
    <div className="h-screen bg-gray-50 text-slate-800 flex overflow-hidden">
      {/* Chat panel */}
      <div className="flex-1 flex flex-col max-w-2xl mx-auto py-10 px-6 h-full">
      ...
      <div className="w-80 border-l border-gray-200 bg-white py-10 px-5 h-full flex flex-col">
        ...
        {stats ? (
          <>
            ...
            <h3 className="text-xs font-medium text-slate-400 uppercase tracking-wide mb-2 shrink-0">Recent events</h3>
